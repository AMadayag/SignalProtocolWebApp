 ...
 */
export declare class SvrKey extends ByteArray {
...
export declare class PinHash {
     ...
     */
    static fromSalt(normalizedPin: Uint8Array<ArrayBuffer>, salt: Uint8Array<ArrayBuffer>): PinHash;
    /**
     ...
     */
    static fromUsernameMrenclave(normalizedPin: Uint8Array<ArrayBuffer>, username: string, mrenclave: Uint8Array<ArrayBuffer>): PinHash;
...
export declare const Pin: {
     ...
     */
    verifyLocalHash(encodedHash: string, normalizedPin: Uint8Array<ArrayBuffer>): boolean;
};
/**
