...
export declare class InternalRequest implements Native.Wrapper<Native.HttpRequest> {
    ...
    static getNextGrpcMessage(name: string, body: Uint8Array<ArrayBuffer>): [Uint8Array<ArrayBuffer>, unknown];
    getSingleGrpcMessage(name: string): unknown;
}
...
export declare class FakeChatRemote {
    ...
    receiveIncomingGrpcRequest(): Promise<InternalRequest | null>;
    assertReceiveIncomingGrpcRequest(): Promise<InternalRequest>;
    sendRawGrpcReplyTo(request: InternalRequest, response: Uint8Array<ArrayBuffer> | Native.GrpcTestCaseBridgedResponse): Promise<void>;
    static encodeSingleGrpcMessage(name: string, json: Record<string, unknown>): Uint8Array<ArrayBuffer>;
    sendGrpcReplyTo(request: InternalRequest, name: string, response: Record<string, unknown>): Promise<void>;
}
