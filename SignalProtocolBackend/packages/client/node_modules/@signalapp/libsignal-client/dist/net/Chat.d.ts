...
export declare class UnauthenticatedChatConnection implements ChatConnection {
     ...
     */
    static fakeConnect(asyncContext: TokioAsyncContext, listener: ChatServiceListener, grpcOverrides?: ReadonlyArray<string>): [UnauthenticatedChatConnection, FakeChatRemote];
    private constructor();
    fetch(chatRequest: ChatRequest, options?: RequestOptions): Promise<Native.ChatResponse>;
    disconnect(): Promise<void>;
    connectionInfo(): ConnectionInfo;
...
export declare class AuthenticatedChatConnection implements ChatConnection {
     ...
     * connection.
     */
    static fakeConnect(asyncContext: TokioAsyncContext, listener: ChatServiceListener, grpcOverrides?: ReadonlyArray<string>, alerts?: ReadonlyArray<string>): [AuthenticatedChatConnection, FakeChatRemote];
    private constructor();
