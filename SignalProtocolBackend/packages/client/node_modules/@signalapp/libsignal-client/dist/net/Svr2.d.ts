 ...
 */
export declare class Svr2BackupSession {
...
export declare class Svr2 {
    ...
    }, masterKey: Uint8Array<ArrayBuffer>, maxTries: number, options?: {
     ...
     * `data` blob.
     */
    startBackup(hashedPin: Uint8Array<ArrayBuffer>, data: Uint8Array<ArrayBuffer>, maxTries: number, options?: {
        abortSignal?: AbortSignal;
    }): Promise<Svr2BackupSession>;
    /**
     ...
     * @throws {SvrAttestationError} if enclave attestation fails.
     */
    finishBackup(session: Svr2BackupSession, options?: {
        abortSignal?: AbortSignal;
    }): Promise<void>;
    /**
     ...
     */
    restore(pin: Uint8Array<ArrayBuffer>, options?: {
        abortSignal?: AbortSignal;
