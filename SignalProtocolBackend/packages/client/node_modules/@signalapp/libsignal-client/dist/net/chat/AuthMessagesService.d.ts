import { RequestOptions, UploadForm } from '../Chat.js';
...
export interface AuthMessagesService {
     ...
     */
    sendMessage: (request: SendMessageRequest, options?: RequestOptions) => Promise<void>;
    /**
     ...
     * @see {@link MismatchedDevicesEntry}
     */
    sendSyncMessage: (request: SendSyncMessageRequest, options?: RequestOptions) => Promise<void>;
}
