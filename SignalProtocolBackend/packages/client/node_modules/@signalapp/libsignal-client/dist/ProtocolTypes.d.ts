...
export declare class SignedPreKeyRecord implements SignedPublicPreKey {
    ...
    static new(id: number, timestamp: number, pubKey: PublicKey, privKey: PrivateKey, signature: Uint8Array<ArrayBuffer>): SignedPreKeyRecord;
...
export declare class PreKeyBundle {
    ...
    static new(registration_id: number, device_id: number, prekey_id: number | null, prekey: PublicKey | null, signed_prekey_id: number, signed_prekey: PublicKey, signed_prekey_signature: Uint8Array<ArrayBuffer>, identity_key: PublicKey, kyber_prekey_id: number, kyber_prekey: KEMPublicKey, kyber_prekey_signature: Uint8Array<ArrayBuffer>): PreKeyBundle;
    deviceId(): number;
