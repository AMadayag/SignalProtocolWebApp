...
import { convertNativeRegistrationSessionState, } from './net/RegistrationSession.js';
...
(function (ErrorCode) {
    ...
    ErrorCode[ErrorCode["DeviceIdNotFound"] = 50] = "DeviceIdNotFound";
    ErrorCode[ErrorCode["UploadTooLarge"] = 51] = "UploadTooLarge";
    ErrorCode[ErrorCode["RegistrationCredentialsCouldNotBeParsed"] = 52] = "RegistrationCredentialsCouldNotBeParsed";
    ErrorCode[ErrorCode["RegistrationDeviceTransferPossibleNotSkipped"] = 53] = "RegistrationDeviceTransferPossibleNotSkipped";
    ErrorCode[ErrorCode["RegistrationLock"] = 54] = "RegistrationLock";
    ErrorCode[ErrorCode["RegistrationRecoveryVerificationFailed"] = 55] = "RegistrationRecoveryVerificationFailed";
    ErrorCode[ErrorCode["RegistrationRequestInvalid"] = 56] = "RegistrationRequestInvalid";
    ErrorCode[ErrorCode["RegistrationRequestRejected"] = 57] = "RegistrationRequestRejected";
    ErrorCode[ErrorCode["RegistrationSessionIdInvalid"] = 58] = "RegistrationSessionIdInvalid";
    ErrorCode[ErrorCode["RegistrationSessionNotFound"] = 59] = "RegistrationSessionNotFound";
    ErrorCode[ErrorCode["RegistrationSessionNotReadyForVerification"] = 60] = "RegistrationSessionNotReadyForVerification";
    ErrorCode[ErrorCode["RegistrationVerificationCodeNotDeliverable"] = 61] = "RegistrationVerificationCodeNotDeliverable";
    ErrorCode[ErrorCode["RegistrationVerificationSendFailed"] = 62] = "RegistrationVerificationSendFailed";
    ErrorCode[ErrorCode["UsernameNotAvailable"] = 63] = "UsernameNotAvailable";
    ErrorCode[ErrorCode["UsernameNotSet"] = 64] = "UsernameNotSet";
})(ErrorCode || (ErrorCode = {}));
/**
...
export class LibSignalErrorBase extends Error {
    ...
    get sessionState() {
        ...
        return convertNativeRegistrationSessionState(newNativeHandle(this._sessionState));
    }
    toString() {
