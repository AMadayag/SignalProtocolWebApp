...
import { CiphertextMessage, CiphertextMessageConvertible } from './CiphertextMessage.js';
...
import { KyberPreKeyRecord, PreKeyBundle, PreKeyRecord, SignedPreKeyRecord } from './ProtocolTypes.js';
...
export declare class SessionRecord {
     ...
     */
    hasCurrentState(requirePqRatio: number, now?: Date): boolean;
...
export declare abstract class KyberPreKeyStore {
...
export declare function processPreKeyBundle(bundle: PreKeyBundle, address: ProtocolAddress, localAddress: ProtocolAddress, sessionStore: SessionStore, identityStore: IdentityKeyStore, now?: Date): Promise<void>;
export declare function signalEncrypt(message: Uint8Array<ArrayBuffer>, address: ProtocolAddress, localAddress: ProtocolAddress, sessionStore: SessionStore, identityStore: IdentityKeyStore, now?: Date): Promise<CiphertextMessage>;
export declare function signalDecrypt(message: SignalMessage, address: ProtocolAddress, localAddress: ProtocolAddress, sessionStore: SessionStore, identityStore: IdentityKeyStore): Promise<Uint8Array<ArrayBuffer>>;
export declare function signalDecryptPreKey(message: PreKeySignalMessage, address: ProtocolAddress, localAddress: ProtocolAddress, sessionStore: SessionStore, identityStore: IdentityKeyStore, prekeyStore: PreKeyStore, signedPrekeyStore: SignedPreKeyStore, kyberPrekeyStore: KyberPreKeyStore): Promise<Uint8Array<ArrayBuffer>>;
 ...
 */
export declare class Svr2Client {
    readonly _nativeHandle: Native.SgxClientState;
    private constructor();
    /**
     * Creates a new instance of the client using the attestation message
     */
    static new(mrenclave: Uint8Array<ArrayBuffer>, attestationMsg: Uint8Array<ArrayBuffer>, currentTimestamp: Date): Svr2Client;
