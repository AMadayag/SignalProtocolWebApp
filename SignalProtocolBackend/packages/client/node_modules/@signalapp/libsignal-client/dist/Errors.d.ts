...
import { RegistrationSessionState } from './net/RegistrationSession.js';
export declare enum ErrorCode {
    ...
    DeviceIdNotFound = 50,
    UploadTooLarge = 51,
    RegistrationCredentialsCouldNotBeParsed = 52,
    RegistrationDeviceTransferPossibleNotSkipped = 53,
    RegistrationLock = 54,
    RegistrationRecoveryVerificationFailed = 55,
    RegistrationRequestInvalid = 56,
    RegistrationRequestRejected = 57,
    RegistrationSessionIdInvalid = 58,
    RegistrationSessionNotFound = 59,
    RegistrationSessionNotReadyForVerification = 60,
    RegistrationVerificationCodeNotDeliverable = 61,
    RegistrationVerificationSendFailed = 62,
    UsernameNotAvailable = 63,
    UsernameNotSet = 64
}
...
export declare class LibSignalErrorBase extends Error {
    ...
    get sessionState(): RegistrationSessionState | undefined;
    toString(): string;
...
export type RegistrationSessionNotReadyForVerificationError = LibSignalErrorCommon & {
...
export type RegistrationVerificationCodeNotDeliverableError = LibSignalErrorCommon & {
...
export type RegistrationDeviceTransferPossibleNotSkippedError = LibSignalErrorCommon & {
    code: ErrorCode.RegistrationDeviceTransferPossibleNotSkipped;
};
export type RegistrationRecoveryVerificationFailedError = LibSignalErrorCommon & {
    code: ErrorCode.RegistrationRecoveryVerificationFailed;
};
export type RegistrationCredentialsCouldNotBeParsedError = LibSignalErrorCommon & {
