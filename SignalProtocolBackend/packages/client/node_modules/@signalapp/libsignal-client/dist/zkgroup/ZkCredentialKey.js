...
export class ZkCredentialKeyPair extends ByteArray {
    ...
    static generateWithRandom(random) {
        return new ZkCredentialKeyPair(Native.ZkCredentialKeyPair_GenerateDeterministic(random));
    }
    constructor(contents) {
        super(contents, Native.ZkCredentialKeyPair_CheckValidContents);
    }
    getPublicKey() {
        return new ZkCredentialPublicKey(Native.ZkCredentialKeyPair_GetPublicKey(this.contents));
    }
}
...
//# sourceMappingURL=ZkCredentialKey.js.map